...
namespace vrmath
{
	...
	inline vr::HmdQuaternion_t quaternionFromYawRollPitch(double yaw, double roll, double pitch)
	{
		return quaternionFromRotationY(yaw) * quaternionFromRotationZ(roll) * quaternionFromRotationX(pitch);
	}
